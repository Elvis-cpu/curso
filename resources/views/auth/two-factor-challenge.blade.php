<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <img class="w-16 h-16 rounded-full" viewbox="0 0 48 48" fill="none" src="{{ asset('https://cdn.pixabay.com/photo/2016/10/16/16/33/dual-screen-1745705_960_720.png') }}" />
        </x-slot>
